...
const SingleOffer = () => {
    ...
    const fetchData = async () => {
        try {
            const docRef = doc(firestore, "Suites-Offers", id); // Reference to the document
                        ...
                        <div className='relative'>
                            <div className='!mr-40'>
                                ...
                                <p className='text-justify mt-6'
                                    contentEditable={isEditable}
                                    ref={featuresRef}
                                    dangerouslySetInnerHTML={{ __html: offer?.features ?? "Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni mollitia ullam, minima voluptatibus explicabo ducimus illum sapiente doloremque! Corrupti, officia? Perspiciatis sequi ut sapiente reprehenderit nemo inventore ea non distinctio?" }}
                                ></p>
                            </div>
                        </div>
                    </div>
