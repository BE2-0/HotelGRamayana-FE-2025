                    ...
                    <div class="font-[sans-serif]" style={{
                        ...
                        <div class="min-h-screen flex flex-col items-center justify-center backdrop-blur-sm px-5">
                            <div class="flex items-center gap-4 max-md:gap-8 max-w-xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md bg-white">
                                <div class="w-full px-4 py-4">
                                    <form onSubmit={onSubmit}>
                                        <div class="mb-6">
                                            <h3 class="text-gray-800 text-3xl font-canela font-bold text-center">Sign in</h3>
                                            {/* <p class="text-sm mt-4 text-gray-800"><Link to="/register" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Back to home</Link></p> */}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="relative flex items-center">
                                                <input name="email" type="text" value={email}
                                                    onChange={(e) => setEmail(e.target.value)} class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
                                        ...
                                        <div class="mt-8">
                                            ...
                                            <div class="relative flex items-center">
                                                <input name="password" type={`${isPasswordVisible ? 'text' : 'password'}`} value={password}
                                                    onChange={(e) => setPassword(e.target.value)} class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
                          ...
                          <path d="M64 104C22.127 104 1.367 67.496.504 65.943a4 4 0 0 1 0-3.887C1.367 60.504 22.127 24 64 24s62.633 36.504 63.496 38.057a4 4 0 0 1 0 3.887C126.633 67.496 105.873 104 64 104zM8.707 63.994C13.465 71.205 32.146 96 64 96c31.955 0 50.553-24.775 55.293-31.994C114.535 56.795 95.854 32 64 32 32.045 32 13.447 56.775 8.707 63.994zM64 88c-13.234 0-24-10.766-24-24s10.766-24 24-24 24 10.766 24 24-10.766 24-24 24zm0-40c-8.822 0-16 7.178-16 16s7.178 16 16 16 16-7.178 16-16-7.178-16-16-16z" data-original="#000000"></path>
                                        ...
                                        <div>
                                            <p class="text-sm mt-4 text-gray-800"><Link to="/" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Back to home</Link></p>
                                        </div>
